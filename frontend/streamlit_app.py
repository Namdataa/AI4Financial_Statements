...
.sidebar {
    width: 230px;
    height: 100vh;
    background-color: #1e88e5;  /* Màu xanh giống trong mã của bạn */
    color: white;
...
with st.sidebar:
    selected = option_menu(
        ...
        styles={
            "container": {"padding": "0!important", "background-color": "#1e88e5"},
            "icon": {"color": "white", "font-size": "18px"}, 
            "nav-link": {"color": "white", "font-size": "16px", "text-align": "left", "margin":"0px", "--hover-color": "rgba(255, 255, 255, 0.1)"},
...
with col2:
    ...
    with chat_container:
        chat_html = """
        <div style="height: 700px; overflow-y: auto; display: flex; flex-direction: column-reverse;">
        """
